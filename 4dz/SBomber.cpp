    ...
    score(0)
{
    ...
    HouseBuilderDefault houseDefault;
    HouseBuilderWithGarage houseWithGarage;
    HouseBuilderRuins houseRuins;

    srand(time(0));
    if (rand() % 2 == 0)
    {
        Director::createHouse(houseDefault, *pHouse);
    }
    else if (rand() % 2 == 0)
    {
        Director::createHouse(houseWithGarage, *pHouse);
    }
    else
    {
        Director::createHouse(houseRuins, *pHouse);
    }
